...
class Config:
    ...
    # ------------------------------------------------
    DATA_PATH = "/home/yagyik/finance_trials/data/HMSMC_repo_and_aux/tiingo_downloader/data_extensive/"     # Update with your dataset path
    SOURCE_TYPE = "compressed"                # "csv", "yfinance", "tiingo", or "compressed"
    ...
    # LSTM Hyperparams
    LSTM_INPUT_DIM = 376              # Adjust based on your dataset's number of features
